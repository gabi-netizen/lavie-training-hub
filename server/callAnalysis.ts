...
${stagesJson}
  ...
  "tcRead": <bool — FULL OFFER DETAILS CHECK: Set TRUE if the agent clearly communicated ALL of the following: (1) the £4.95 postage charge, (2) the 21-day free trial period, (3) the £44.95 recurring price every 60 days after the trial, (4) 48-hour premium delivery with signature on arrival, AND (5) the full Terms & Conditions read out in full (not just referenced or summarised — the actual T&C wording must be spoken). Set FALSE if any of these key details were missing or if the T&Cs were only referenced but not read out.>,
  ...
  "complianceIssues": [<list of specific compliance violations as strings. Examples: "Rep denied subscription when directly asked", "£4.95 postage not mentioned", "21-day trial period not mentioned", "£44.95 recurring price not mentioned", "Cancellation/pause rights not mentioned", "48-hour premium delivery with signature not mentioned", "Full T&Cs not read out">],${extraFields}
}
...
2. FULL OFFER DETAILS (tcRead): The rep must clearly communicate ALL of: £4.95 postage, 21-day free trial, £44.95 every 60 days, 48-hour premium delivery with signature on arrival, AND the full Terms & Conditions read out verbatim (not just referenced). Missing any of these = tcRead=false → deduct 20-30 from complianceScore.
