                ...
                >
                  ...
                  <div
                    ...
                    onClick={(e) => {
                      e.stopPropagation();
                      if (sub.contactId) {
                        window.location.href = `/contacts/${sub.contactId}?from=retention&agent=${encodeURIComponent(agentName || "Rob")}&subId=${encodeURIComponent(sub.subscriptionId)}&tab=endInstalment`;
                      }
                    }}
                  >
                    {sub.customerName}
