          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-4">
            ...
            <div className="grid grid-cols-4 gap-2">
              <button
                ...
                className="flex flex-col items-center gap-1 py-2.5 px-2 rounded-xl border-none bg-[#15803d] text-white text-xs font-bold transition-colors hover:bg-[#166534] disabled:opacity-40 disabled:cursor-not-allowed"
              >
