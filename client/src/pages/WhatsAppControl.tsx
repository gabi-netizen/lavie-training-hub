...
export default function WhatsAppControl() {
  ...
  // WhatsApp official logo (green circle with white phone)
  ...
  // SMS icon (blue chat bubble with dots)
  const SmsIcon = ({ size = 16, className = "" }: { size?: number, className?: string }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" className={className} style={{ flexShrink: 0 }}>
      <rect width="24" height="24" rx="12" fill="#2563eb" />
      <path d="M7 8.5h10M7 12h6" stroke="white" strokeWidth="1.8" strokeLinecap="round" />
      <path d="M5 6.5C5 5.67 5.67 5 6.5 5h11c.83 0 1.5.67 1.5 1.5v8c0 .83-.67 1.5-1.5 1.5H9l-3 2.5V16H6.5C5.67 16 5 15.33 5 14.5v-8z" stroke="white" strokeWidth="1.3" fill="none" />
    </svg>
  );
  ...
  return (
    <div className="flex h-[calc(100vh-56px)] bg-white overflow-hidden">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-1.5 min-w-0">
                        ...
                        {/* Channel icon: WhatsApp logo or SMS icon */}
            ...
            <div className="bg-white rounded-lg p-3 border border-gray-200">
              ...
              <div className="space-y-1.5">
                ...
                <button
                  ...
                  className="w-full text-[11px] px-2 py-1.5 bg-orange-600 text-white rounded hover:bg-orange-500 flex items-center justify-center gap-1"
                >
                  <Users size={12} />
                  Send to Retention
                </button>
      ...
      {showRetentionModal && (
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50" onClick={() => setShowRetentionModal(false)}>
