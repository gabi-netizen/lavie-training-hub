    ...
    >
      ...
      {isActive && (
        <div className="ws-expanded" onClick={(e) => e.stopPropagation()}>
          ...
          <div className="ws-btn-pair" style={{ flexWrap: 'nowrap', gap: 4, marginTop: 4, marginBottom: 4 }}>
            <button className="ws-btn-pay ws-btn-pair-item" onClick={() => setPayOpen(!payOpen)} style={{ display: 'flex', alignItems: 'center', gap: 4, fontSize: 10, padding: '4px 6px', flex: '1 1 0', justifyContent: 'center', whiteSpace: 'nowrap' }}>
              <CreditCard size={11} /> Take Payment
            </button>
            <button
              className="ws-btn-email ws-btn-pair-item"
              onClick={() => setEmailTemplateOpen(true)}
              style={{ display: 'flex', alignItems: 'center', gap: 4, fontSize: 10, padding: '4px 6px', flex: '1 1 0', justifyContent: 'center', whiteSpace: 'nowrap' }}
            >
            ...
            <button
              ...
              style={{ display: 'flex', alignItems: 'center', gap: 3, fontSize: 10, padding: '4px 6px', flex: '1 1 0', justifyContent: 'center', whiteSpace: 'nowrap', background: '#16a34a', color: '#fff', border: 'none' }}
            >
