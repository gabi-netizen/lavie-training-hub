 ...
 *
 * Columns: Agent, Daily Openings, Ave/Days, Cancelled Trials, Working Days,
 *          Free Trials, Cancellation %
 *
 * Admin-only page.
 *
 * NOTE: This page currently displays placeholder/empty data.
 * Backend data integration will be added in a subsequent task.
 */
...
// ─── Placeholder data ─────────────────────────────────────────────────────────
// Replace with real API/tRPC data when backend is ready.
...
export default function OpeningDashboard() {
  ...
  const sortedRows = useMemo<AgentRow[]>(() => {
    return [...PLACEHOLDER_ROWS].sort((a, b) => {
  ...
  const totalTrials = sortedRows.reduce((s, r) => s + r.freeTrials, 0);
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b border-gray-200 px-4 sm:px-6 py-4 flex items-center justify-between gap-3">
        ...
        {/* Placeholder badge — remove once backend is wired up */}
      ...
      <div className="px-4 sm:px-6 py-4 space-y-5">
                  ...
                  <tr>
                    <td colSpan={8} className="px-4 py-12 text-center">
                      ...
                      <p className="text-sm text-gray-500 mt-1">
                        Backend data integration is pending. Agent rows will appear here once connected.
                      </p>
                    </td>
                  </tr>
                ) : (
        ...
        <p className="text-xs text-gray-500 text-center pb-4">
          Opening Agents Dashboard · Backend data integration pending
        </p>
      </div>
    </div>
  );
